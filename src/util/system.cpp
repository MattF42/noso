...
const char * const BITCOIN_CONF_FILENAME = "nosor.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\NOSORCore
    // macOS: ~/Library/Application Support/NOSORCore
    // Unix-like: ~/.nosorcore
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "NOSORCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/NOSORCore";
#else
    // Unix-like
    return pathRet / ".nosorcore";
#endif
#endif
}
