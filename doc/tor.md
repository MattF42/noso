...
versions of Tor see [Section 4](#4-automatically-listen-on-tor).*
    ...
    HiddenServicePort 20666 127.0.0.1:9996

The directory can be different of course, but virtual port numbers should be equal to
your dashd's P2P listen port (20666 by default), and target addresses and ports
...
and open port 20666 on your firewall (or use port mapping, i.e., `-upnp` or `-natpmp`).
...
```
nc -v -x 127.0.0.1:9050 -z *.onion 20666
```
