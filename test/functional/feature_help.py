...
"""Verify that starting nosord with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nosord with -h for help text")
        ...
        self.log.info("Start nosord with -version for version information")
